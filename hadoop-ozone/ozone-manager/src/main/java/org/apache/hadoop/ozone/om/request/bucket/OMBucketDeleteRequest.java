...
public class OMBucketDeleteRequest extends OMClientRequest {
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
      long transactionLogIndex, OzoneManagerDoubleBufferHelper ozoneManagerDoubleBufferHelper) {
    ...
    try {
      ...
      ozoneManagerDoubleBufferHelper.add(omClientResponse, transactionLogIndex);
      if (acquiredLock) {
