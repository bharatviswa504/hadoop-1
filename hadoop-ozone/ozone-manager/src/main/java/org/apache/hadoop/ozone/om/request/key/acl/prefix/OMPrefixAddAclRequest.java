...
public class OMPrefixAddAclRequest extends OMPrefixAclRequest {
  ...
  private static QuadFunction<OzoneObj, List<OzoneAcl>, OmPrefixInfo,
        PrefixManagerImpl, OMPrefixAclOpResult, IOException> prefixAddAclOp;
  private OzoneObj ozoneObj;
  private List<OzoneAcl> ozoneAcls;


  static {
    prefixAddAclOp = (ozoneObj, ozoneAcls, omPrefixInfo, prefixManager) -> {
      return prefixManager.addAcl(ozoneObj, ozoneAcls.get(0), omPrefixInfo);
    };
  }

  public OMPrefixAddAclRequest(OMRequest omRequest) {
    super(omRequest, prefixAddAclOp);
  ...
  void onComplete(boolean operationResult, IOException exception,
    ...
    if (operationResult) {
      ...
      if (exception == null) {
        ...
        LOG.error("Add acl {} to path {} failed!", getAcls(),
